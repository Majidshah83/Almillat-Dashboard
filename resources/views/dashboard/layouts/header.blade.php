 <div class="top-bar">
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                            ...
                            <img alt="Midone - HTML Admin Template" src="{{asset('upload/profile/'.Auth::user()->image)}}">
                        </div>
  ...
  Auth::user()->roles->pluck('name')[0])){{Auth::user()->roles->pluck('name')[0]}}@endif</div>
                                ...
                                <li>
                                    <a href="{{route('signout')}}" class="dropdown-item hover:bg-white/5"> <i data-lucide="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
                                </li>
                            </ul>
                        </div>
                    </div>
